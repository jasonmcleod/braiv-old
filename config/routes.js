...
module.exports.routes = {
  ...
  '/status': 'RouteController.status',

  '/assets/maptiles': 'AssetsController.maptiles',
  '/assets/levels': 'AssetsController.levels',
  '/assets/npcs': 'AssetsController.npcs',
  '/assets/map/:map': 'AssetsController.map',
