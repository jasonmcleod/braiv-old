...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    shipit: {
      options: {
        ...
        workspace: '/tmp/braiv-workspace',

        // Project will be deployed in this directory.
        deployTo: '/root/braiv-sails/',

        // Repository url.
        repositoryUrl: 'git@bitbucket.org:jasonmcleod/braiv-angular.git',
  ...
  grunt.registerTask('remote:restart', function () {
    grunt.shipit.remote('cd /root/braiv-sails/current/ && npm prune && npm install && forever stopall && NODE_ENV=production forever start app.js', this.async());
  });
