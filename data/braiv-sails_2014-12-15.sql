...
# Generation Time: 2014-12-15 16:30:09 +0000
# ************************************************************
...
VALUES
	(67,79,40,40,0,1,-1,'',0,0,0,0,'warrior',0,0,'mainland',2,'2015-01-23 17:16:36','2014-12-14 20:07:08',2,'Jeezle'),
...
VALUES
	(1,1,5000,16,'Unnamed Encounter',30,83,24,23,'mainland','2014-12-14 20:06:36','2014-12-14 20:06:36',0,0,NULL),
	(2,1,5000,16,'Unnamed Encounter',42,28,30,29,'mainland','2014-12-14 20:06:36','2014-12-14 20:06:36',0,0,NULL);
...
VALUES
	(1,NULL,NULL,1,4,10,100,1),
	(2,NULL,NULL,3,2,10,100,1);
...
INSERT INTO `inventoryitem` (`item`, `quantity`, `slot`, `id`, `createdAt`, `updatedAt`, `character`)
VALUES
	(2,1,0,1,'2014-12-14 19:54:47','2014-12-14 19:54:47',2),
	(2,1,1,2,'2014-12-14 19:54:49','2014-12-14 19:54:49',2),
	(2,1,2,3,'2014-12-14 19:54:51','2014-12-14 19:54:51',2),
	(1,750,3,4,'2014-12-15 05:54:54','2014-12-14 19:57:26',2),
	(2,1,4,5,'2014-12-14 19:55:06','2014-12-14 19:55:06',2),
	(2,1,5,6,'2014-12-14 19:55:08','2014-12-14 19:55:08',2),
	(2,1,6,7,'2014-12-14 19:55:10','2014-12-14 19:55:10',2),
	(2,1,7,8,'2014-12-14 19:57:24','2014-12-14 19:57:24',2),
	(2,1,8,9,'2014-12-14 19:57:27','2014-12-14 19:57:27',2),
	(2,1,9,10,'2014-12-14 19:57:41','2014-12-14 19:57:41',2),
	(2,1,10,11,'2014-12-14 19:57:53','2014-12-14 19:57:53',2),
	(2,1,11,12,'2014-12-14 19:57:54','2014-12-14 19:57:54',2),
	(2,1,12,13,'2014-12-14 19:57:56','2014-12-14 19:57:56',2),
	(2,1,13,14,'2014-12-14 20:05:16','2014-12-14 20:05:16',2),
	(2,1,14,15,'2014-12-14 20:05:17','2014-12-14 20:05:17',2),
	(2,1,15,16,'2014-12-14 20:05:18','2014-12-14 20:05:18',2),
	(2,1,16,17,'2014-12-14 20:05:31','2014-12-14 20:05:31',2),
	(2,1,17,18,'2014-12-14 20:05:32','2014-12-14 20:05:32',2),
	(2,1,18,19,'2014-12-14 20:05:34','2014-12-14 20:05:34',2),
	(2,1,19,20,'2014-12-14 20:06:05','2014-12-14 20:06:05',2),
	(2,1,20,21,'2014-12-14 20:06:25','2014-12-14 20:06:25',2),
	(2,1,21,22,'2014-12-14 20:06:26','2014-12-14 20:06:26',2),
	(2,1,22,23,'2014-12-14 20:06:27','2014-12-14 20:06:27',2),
	(2,1,23,24,'2014-12-14 20:06:41','2014-12-14 20:06:41',2);
...
INSERT INTO `user` (`id`, `email`, `password`, `activated`, `createdAt`, `updatedAt`, `username`, `name`)
VALUES
	(2,NULL,'3b6eebc053affc3e',1,'2014-12-10 17:53:08','2014-12-10 17:53:08','a',NULL);
...
LOCK TABLES `worldfixture` WRITE;
/*!40000 ALTER TABLE `worldfixture` DISABLE KEYS */;

INSERT INTO `worldfixture` (`id`, `fixture`, `x`, `y`, `map`, `createdAt`, `updatedAt`, `meta`, `visible`)
VALUES
	(1,2,64,76,'mainland',NULL,NULL,NULL,1),
	(2,2,64,68,'mainland',NULL,NULL,NULL,1),
	(3,2,74,72,'mainland',NULL,NULL,'{\"locked\":true}',1);

/*!40000 ALTER TABLE `worldfixture` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `worlditem` WRITE;
/*!40000 ALTER TABLE `worlditem` DISABLE KEYS */;

INSERT INTO `worlditem` (`item`, `quantity`, `x`, `y`, `map`, `id`, `createdAt`, `updatedAt`)
VALUES
	(1,250,66,76,'mainland',1,'2014-12-14 20:06:36','2014-12-14 20:06:36'),
	(1,250,66,77,'mainland',2,'2014-12-14 20:06:36','2014-12-14 20:06:36'),
	(2,1,66,79,'mainland',4,'2014-12-14 20:06:36','2014-12-14 20:06:36'),
	(2,1,66,80,'mainland',5,'2014-12-14 20:06:36','2014-12-14 20:06:36');

/*!40000 ALTER TABLE `worlditem` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `worldnpc` WRITE;
/*!40000 ALTER TABLE `worldnpc` DISABLE KEYS */;

INSERT INTO `worldnpc` (`id`, `npc`, `x`, `y`, `map`, `encounter`, `createdAt`, `updatedAt`, `lastMove`, `permanent`)
VALUES
	(1,2,61,68,'mainland',1,'2014-12-14 20:06:34','2014-12-14 20:06:34',-1,1),
	(2,1,47,92,'mainland',1,'2014-12-14 20:06:36','2014-12-14 20:06:36',-1,-1),
	(3,1,34,106,'mainland',1,'2014-12-14 20:06:36','2014-12-14 20:06:36',-1,-1),
	(4,1,35,92,'mainland',1,'2014-12-14 20:06:36','2014-12-14 20:06:36',-1,-1),
	(5,1,40,95,'mainland',1,'2014-12-14 20:06:36','2014-12-14 20:06:36',-1,-1),
	(6,1,48,89,'mainland',1,'2014-12-14 20:06:36','2014-12-14 20:06:36',-1,-1),
	(7,3,45,104,'mainland',1,'2014-12-14 20:06:36','2014-12-14 20:06:36',-1,-1),
	(8,3,35,96,'mainland',1,'2014-12-14 20:06:36','2014-12-14 20:06:36',-1,-1),
	(9,3,49,88,'mainland',1,'2014-12-14 20:06:36','2014-12-14 20:06:36',-1,-1),
	(10,3,51,87,'mainland',1,'2014-12-14 20:06:36','2014-12-14 20:06:36',-1,-1),
	(11,3,36,92,'mainland',1,'2014-12-14 20:06:36','2014-12-14 20:06:36',-1,-1),
	(12,3,44,84,'mainland',1,'2014-12-14 20:06:36','2014-12-14 20:06:36',-1,-1),
	(13,3,33,86,'mainland',1,'2014-12-14 20:06:36','2014-12-14 20:06:36',-1,-1),
	(14,3,43,88,'mainland',1,'2014-12-14 20:06:36','2014-12-14 20:06:36',-1,-1);

/*!40000 ALTER TABLE `worldnpc` ENABLE KEYS */;
UNLOCK TABLES;
